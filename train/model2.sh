python train.py --eval_interval 1 --img_height 192 --img_width 256 --batch_size 16 --epochs 20 --num_workers 2 \
...
--img_dir CameraRGB --mask_dir CameraSeg --log_dir ./output/train/model2